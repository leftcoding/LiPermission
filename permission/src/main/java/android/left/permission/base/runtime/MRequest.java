...
import android.left.permission.base.bridge.BridgeRequest;
import android.left.permission.base.checker.DoubleChecker;
import android.left.permission.base.checker.PermissionChecker;
import android.left.permission.base.checker.StandardChecker;
import android.os.AsyncTask;

import java.util.ArrayList;
import java.util.List;

import android.left.permission.base.bridge.RequestManager;
...
//            }
    ...
    private static List<String> getDeniedPermissions(PermissionChecker checker, Source source, String... permissions) {
        List<String> deniedList = new ArrayList<>(0);
